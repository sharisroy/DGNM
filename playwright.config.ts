...
export default defineConfig({
  ...
  fullyParallel: true,
  /* Large PDF downloads + OCR passes can take a long time */
  ...
  projects: [
    ...
    {
      /* Prepares the shared keyword/match-count output folders once, before the parallel chunk workers write to them. */
      name: 'keyword-setup',
      testMatch: /keyword-setup\.spec\.ts/,
      use: { ...devices['Desktop Chrome'] },
      dependencies: ['setup'],
    },
    {
